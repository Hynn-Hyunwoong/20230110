...
var generateSyncTask = function generateSyncTask(index) {
  return function (x) {
    return function (cb) {
      console.log(x);
      cb(null);
...
var generateAsyncTask = function generateAsyncTask(index) {
  return function (x) {
    return function (cb) {
      setTimeout(function () {
        console.log(x);
...
var generateSyncTasks = function generateSyncTasks(count) {
  var tasks = [];
...
var generateAsyncTasks = function generateAsyncTasks(count) {
  var tasks = [];
...
var generateRandomTasks = function generateRandomTasks(count) {
  var tasks = [];
...
var testSync = function testSync() {
...
var testMixed = function testMixed() {
